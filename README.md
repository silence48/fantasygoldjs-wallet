...
Suppose you want to import the public address `qg3HYD8c4bAVLeEzA9t3Ken3Y3Mni1HZSS`. Use `fantasygold-cli` to dump the private key from wallet:
...
You can decode the raw transaction using `fantasygold-cli`:
